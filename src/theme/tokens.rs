...
/// Heading text
pub const TEXT_HEADING: ThemeToken = ThemeToken::new_static("editor.text.heading");
/// Regular text
pub const TEXT_BODY: ThemeToken = ThemeToken::new_static("editor.text.body");
/// Dim text
pub const TEXT_WEAK: ThemeToken = ThemeToken::new_static("editor.text.weak");
...
pub const BUTTON_PLAIN_BG: ThemeToken = ThemeToken::new_static("editor.button.plain.bg");
/// Plain button background (hovered)
pub const BUTTON_PLAIN_BG_HOVER: ThemeToken =
    ThemeToken::new_static("editor.button.plain.bg.hover");
/// Plain button background (disabled)
pub const BUTTON_PLAIN_BG_DISABLED: ThemeToken =
    ThemeToken::new_static("editor.button.plain.bg.disabled");
/// Plain button background (pressed)
pub const BUTTON_PLAIN_BG_PRESSED: ThemeToken =
    ThemeToken::new_static("editor.button.plain.bg.pressed");
...
pub const SLIDER_BG_HOVER: ThemeToken = ThemeToken::new_static("editor.slider.bg.hover");
/// Background for slider (pressed)
pub const SLIDER_BG_PRESSED: ThemeToken = ThemeToken::new_static("editor.slider.bg.pressed");
/// Background for slider (disabled)
pub const SLIDER_BG_DISABLED: ThemeToken = ThemeToken::new_static("editor.slider.bg.disabled");
...
pub const SLIDER_BAR_HOVER: ThemeToken = ThemeToken::new_static("editor.slider.bar.hover");
/// Fill color for slider (pressed)
pub const SLIDER_BAR_PRESSED: ThemeToken = ThemeToken::new_static("editor.slider.bar.pressed");
...
pub const SCROLLBAR_BG: ThemeToken = ThemeToken::new_static("editor.scrollbar.bg");
/// Background for scrollbar moving bar
pub const SCROLLBAR_THUMB: ThemeToken = ThemeToken::new_static("editor.scrollbar.thumb");
/// Background for scrollbar moving bar (hovered)
pub const SCROLLBAR_THUMB_HOVER: ThemeToken =
    ThemeToken::new_static("editor.scrollbar.thumb.hover");
...
pub const CHECKBOX_BG_HOVER: ThemeToken = ThemeToken::new_static("editor.checkbox.bg.hover");
/// Checkbox background around the checkmark (pressed)
pub const CHECKBOX_BG_PRESSED: ThemeToken = ThemeToken::new_static("editor.checkbox.bg.pressed");
...
pub const CHECKBOX_BG_CHECKED_HOVER: ThemeToken =
    ThemeToken::new_static("editor.checkbox.bg.checked.hover");
/// Checkbox background around the checkmark (checked+pressed)
pub const CHECKBOX_BG_CHECKED_PRESSED: ThemeToken =
    ThemeToken::new_static("editor.checkbox.bg.checked.pressed");
...
pub const CHECKBOX_BORDER_PRESSED: ThemeToken =
    ThemeToken::new_static("editor.checkbox.border.pressed");
/// Checkbox border around the checkmark (disabled)
...
pub const RADIO_BORDER_PRESSED: ThemeToken =
    ThemeToken::new_static("editor.radio.border.pressed");
...
pub const SWITCH_BG_HOVER: ThemeToken = ThemeToken::new_static("editor.switch.bg.hover");
/// Switch background around the switch (pressed)
pub const SWITCH_BG_PRESSED: ThemeToken = ThemeToken::new_static("editor.switch.bg.pressed");
...
pub const SWITCH_BG_CHECKED_HOVER: ThemeToken =
    ThemeToken::new_static("editor.switch.bg.checked.hover");
/// Switch background around the switch (checked+pressed)
pub const SWITCH_BG_CHECKED_PRESSED: ThemeToken =
    ThemeToken::new_static("editor.switch.bg.checked.pressed");
...
pub const SWITCH_BORDER_PRESSED: ThemeToken =
    ThemeToken::new_static("editor.switch.border.hover.pressed");
...
/// Menu background
pub const MENU_BG: ThemeToken = ThemeToken::new_static("editor.menu.bg");
/// Menu border
pub const MENU_BORDER: ThemeToken = ThemeToken::new_static("editor.menu.border");
/// Menu item hovered
pub const MENUITEM_BG_HOVER: ThemeToken = ThemeToken::new_static("editor.menuitem.bg.hover");
/// Menu item pressed
pub const MENUITEM_BG_PRESSED: ThemeToken = ThemeToken::new_static("editor.menuitem.bg.pressed");
/// Menu item focused
pub const MENUITEM_BG_FOCUSED: ThemeToken = ThemeToken::new_static("editor.menuitem.bg.focused");
/// Menu item text
pub const MENUITEM_TEXT: ThemeToken = ThemeToken::new_static("editor.menuitem.text");
/// Menu item text (disabled)
pub const MENUITEM_TEXT_DISABLED: ThemeToken =
    ThemeToken::new_static("editor.menuitem.text.disabled");

// Text Input

/// Background for text input
pub const TEXT_INPUT_BG: ThemeToken = ThemeToken::new_static("editor.textinput.bg");
/// Text color for text input
pub const TEXT_INPUT_TEXT: ThemeToken = ThemeToken::new_static("editor.textinput.text");
/// Text color for text input (disabled)
pub const TEXT_INPUT_TEXT_DISABLED: ThemeToken =
    ThemeToken::new_static("editor.textinput.text.disabled");
/// Cursor color for text input
pub const TEXT_INPUT_CURSOR: ThemeToken = ThemeToken::new_static("editor.textinput.cursor");
/// Selection color for text input
pub const TEXT_INPUT_SELECTION: ThemeToken = ThemeToken::new_static("editor.textinput.selection");
/// Selection color for unfocused text input
pub const TEXT_INPUT_SELECTION_UNFOCUSED: ThemeToken =
    ThemeToken::new_static("editor.textinput.selection.unfocused");
/// Background color for label text
pub const TEXT_INPUT_LABEL_BG: ThemeToken = ThemeToken::new_static("editor.textinput.label.bg");
/// Sigil color for X
pub const TEXT_INPUT_X_AXIS: ThemeToken = ThemeToken::new_static("editor.textinput.axis.x");
/// Sigil color for Y
pub const TEXT_INPUT_Y_AXIS: ThemeToken = ThemeToken::new_static("editor.textinput.axis.y");
/// Sigil color for Z
pub const TEXT_INPUT_Z_AXIS: ThemeToken = ThemeToken::new_static("editor.textinput.axis.z");

// Pane

/// Pane header background
pub const PANE_HEADER_BG: ThemeToken = ThemeToken::new_static("editor.pane.header.bg");
/// Pane header border
pub const PANE_HEADER_BORDER: ThemeToken = ThemeToken::new_static("editor.pane.header.border");
/// Pane header text color
pub const PANE_HEADER_TEXT: ThemeToken = ThemeToken::new_static("editor.pane.header.text");
...
/// Subpane background
pub const SUBPANE_HEADER_BG: ThemeToken = ThemeToken::new_static("editor.subpane.header.bg");
/// Subpane header border
pub const SUBPANE_HEADER_BORDER: ThemeToken =
    ThemeToken::new_static("editor.subpane.header.border");
/// Subpane header text color
pub const SUBPANE_HEADER_TEXT: ThemeToken = ThemeToken::new_static("editor.subpane.header.text");
/// Subpane body background
pub const SUBPANE_BODY_BG: ThemeToken = ThemeToken::new_static("editor.subpane.body.bg");
/// Subpane body border
pub const SUBPANE_BODY_BORDER: ThemeToken = ThemeToken::new_static("editor.subpane.body.border");

// Group

/// Group background
pub const GROUP_HEADER_BG: ThemeToken = ThemeToken::new_static("editor.group.header.bg");
/// Group header border
pub const GROUP_HEADER_BORDER: ThemeToken = ThemeToken::new_static("editor.group.header.border");
/// Group header text color
pub const GROUP_HEADER_TEXT: ThemeToken = ThemeToken::new_static("editor.group.header.text");
/// Group body background
pub const GROUP_BODY_BG: ThemeToken = ThemeToken::new_static("editor.group.body.bg");
/// Group body border
pub const GROUP_BODY_BORDER: ThemeToken = ThemeToken::new_static("editor.group.body.border");
