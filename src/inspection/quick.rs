...
use crate::inspection::{bevy_inspector::Filter, utils::pretty_type_name};
use bevy::app::Plugin;
use bevy::asset::Asset;
use bevy::ecs::{prelude::*, query::QueryFilter, schedule::BoxedCondition};
use bevy_egui::{EguiContext, EguiPlugin, EguiPrimaryContextPass, PrimaryEguiContext};
use bevy::reflect::Reflect;
use bevy::state::state::FreelyMutableState;

use crate::inspection::{DefaultInspectorConfigPlugin, bevy_inspector};
...
/// Remember to call [`App::add_state`](bevy::state::app::AppExtStates::init_state).
///
...
/// use bevy::state::{app::AppExtStates, prelude::States, state::FreelyMutableState};
///
/// fn main() {
///     App::new()
///         .add_plugins(DefaultPlugins)
...
/// Remember to call [`App::register_asset_reflect`](bevy::asset::AssetApp::register_asset_reflect).
///
...
fn check_plugins(app: &bevy::app::App, name: &str) {
