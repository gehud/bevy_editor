...
use ::{
    bevy::asset::Assets, bevy::asset::Handle, bevy::camera::visibility::RenderLayers, bevy::mesh::Mesh,
};

use crate::inspection::bevy_inspector::errors::{no_access, nonexistent_asset_handle};
    ...
    fn ui(
        ...
        match options.display {
            ...
            EntityDisplay::Components => {
                ...
                let entity_name =
                    crate::inspection::utils::guess_entity_name::guess_entity_name_restricted(world, entity);
                egui::CollapsingHeader::new(entity_name)
                    .id_salt(id)
                    .show(ui, |ui| {
                        let _queue = CommandQueue::default();
                        crate::inspection::bevy_inspector::ui_for_entity_components(
                            world,
                            queue.as_deref_mut(),
                            entity,
                            ui,
