...
use crate::inspection::inspector_options::std_options::NumberOptions;
use crate::inspection::reflect_inspector::InspectorUi;
use crate::inspection::reflect_inspector::ProjectorReflect;
                ...
                ui.columns($count, |ui| match ui {
                    [$($component),*] => {
                        $(
                            ...
                            changed |= crate::inspection::inspector_egui_impls::change_slider($component, id, same, |change, overwrite| {
