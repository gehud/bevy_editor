...
use crate::inspection::{
    InspectorOptions,
    inspector_options::{ReflectInspectorOptions, Target, std_options::NumberOptions},
};
...
pub fn register_default_options(type_registry: &mut TypeRegistry) {
    insert_options_struct::<bevy::color::Srgba>(
        type_registry,
        &[
    ...
    insert_options_struct::<bevy::color::LinearRgba>(
        type_registry,
        &[
    ...
    insert_options_struct::<bevy::color::Hsla>(
        type_registry,
        &[
    ...
    insert_options_struct::<bevy::color::Hsva>(
        type_registry,
        &[
            ("hue", &NumberOptions::<f32>::between(0.0, 360.0)),
            ("saturation", &NumberOptions::<f32>::normalized()),
    ...
    insert_options_struct::<bevy::color::Hwba>(
        type_registry,
        &[
            ("hue", &NumberOptions::<f32>::between(0.0, 360.0)),
    ...
    insert_options_struct::<bevy::color::Laba>(
        type_registry,
        &[
    ...
    insert_options_struct::<bevy::color::Lcha>(
        type_registry,
        &[
            ("lightness", &NumberOptions::<f32>::between(0.0, 1.5)),
    ...
    insert_options_struct::<bevy::color::Oklaba>(
        type_registry,
        &[
            ("lightness", &NumberOptions::<f32>::normalized()),
    ...
    insert_options_struct::<bevy::color::Oklcha>(
        type_registry,
        &[
            ("lightness", &NumberOptions::<f32>::normalized()),
    ...
    insert_options_struct::<bevy::color::Xyza>(
        type_registry,
        &[
    ...
    {
        #[rustfmt::skip]
        insert_options_struct::<bevy::render::view::ColorGradingSection>(
            type_registry,
            &[
        ...
        #[rustfmt::skip]
        insert_options_struct::<bevy::render::view::ColorGradingGlobal>(
            type_registry,
            &[
    ...
    {
        #[rustfmt::skip]
        insert_options_struct::<bevy::light::AmbientLight>(
            type_registry,
            &[
        ...
        insert_options_struct::<bevy::light::PointLight>(
            type_registry,
            &[
        ...
        #[rustfmt::skip]
        insert_options_struct::<bevy::light::DirectionalLight>(
            type_registry,
            &[
        ...
        #[rustfmt::skip]
        insert_options_enum::<bevy::light::cluster::ClusterConfig>(
            type_registry,
            &[
                ("FixedZ", "z_slices", &NumberOptions::<u32>::at_least(1)),
                ("XYZ", "dimensions", &NumberOptions::<bevy::math::UVec3>::at_least(bevy::math::UVec3::ONE)),
            ],
        );
    }

    #[rustfmt::skip]
    insert_options_enum::<bevy::camera::Camera3dDepthLoadOp>(
        type_registry,
        &[
