...
/// Map of [`Target`]s to arbitrary [`TypeData`] used to control how the value is displayed, e.g. [`NumberOptions`](crate::inspection::inspector_options::std_options::NumberOptions).
///
...
/// Wrapper of [`struct@InspectorOptions`] to be stored in the [`TypeRegistry`](bevy::reflect::TypeRegistry)
#[derive(Clone)]
...
pub trait InspectorOptionsType {
    ...
    /// Can be arbitrary types which will be passed to [`InspectorEguiImpl`](crate::inspection::inspector_egui_impls::InspectorEguiImpl) like [`NumberOptions`](crate::inspection::inspector_options::std_options::NumberOptions),
