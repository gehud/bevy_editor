...
///
/// # Emitted events
/// * [`bevy::ui_widgets::ValueChange<bool>`] with the new value when the toggle switch changes state.
///
/// These events can be disabled by adding an [`bevy::ui::InteractionDisabled`] component to the bundle
